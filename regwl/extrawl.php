...
<body>
            ...
            <div class="top-header">
                <div id="topshead" class="row">
                    ...
                    <div id="lefts" class="col-sm-6">
                        ...
                        <a id="ic leftpane" style = "color:black;" href="wldp.png" download><i class="fas fa-download"></i></a>
                    </div>
                </div>
            </div>
        </section>
  ...
  <div class="overlay-content">
    <form action="/action_page.php">
      <img src="wldp.png" alt="">
    </form>
  </div>
</div>

        <section>
            <h1 class="text-center mt-4" style="font-family: 'Moon Dance', cursive;"><dt>Weight Loss Exercises</dt></h1>
        </section>
...
<div id="myCarousel" class="carousel slide border-dark rounded border-left border-right border-top" data-ride="carousel">
  ...
  <div class="carousel-item active" data-slide-number="0">
    ...
    <div class="center">
        <div class = "boxed text-center font-weight-bold">Dumbell Lunges</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="dumbell_lunges.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Dumbell Press</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="dumbellpress.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Dumbell Pullovers</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="dumbellpullovers.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Dumbell Tricep Extension</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="dumbelltricepext.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Front Press</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="frontpress.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Front Raises</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="frontraises.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Hammer Curls</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="hammercurls.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Hip Raises</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="hipraises.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Lateral Raises</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="lateralraises.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Leg Raise</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="legraise.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">Modified Pushups</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="modifiedpushups.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="center">
    <div class = "boxed text-center font-weight-bold">One Arm Tricep</div>
      <video width="900" height="400" controls alt="..." data-toggle="lightbox" data-gallery="example-gallery">
    <source src="onearmtricep.mp4" type="video/mp4"> 
    </video>
    </div>
    </div>
    ...
    <div class="carousel-item active">
      <div class="row mx-0">
        <div id="carousel-selector-0" class="thumb col-4 col-sm-2 px-1 py-2 selected" data-target="#myCarousel" data-slide-to="0">
          <video src="dumbell_lunges.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-1" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="1">
        <video src="dumbellpress.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-2" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="2">
        <video src="dumbellpullovers.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-3" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="3">
        <video src="dumbelltricepext.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-4" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="4">
        <video src="frontpress.mp4" class="img-fluid" alt="..."></video>
        </div>
        <div id="carousel-selector-5" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="5">
        <video src="frontraises.mp4" class="img-fluid" alt="..."></video>
        </div>
      </div>
    </div>
